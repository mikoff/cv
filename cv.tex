...
\vspace{-1em}
\begin{longtable}{ p{1.7cm} | p{15.5cm} }
  C/C++ & 7 years of experience. Good understanding of program flow, memory management and real-time systems behaviour. Solid knowledge of standard (STL) and scientific (Eigen) libraries. \\
  Python & 6 years of experience. Used for research, algorithm development and verification. Gained the competence in Numpy, Scipy, Pandas and Scikit-Learn. A lot of experience with visualizations and data representation using Jupyter tools.  \\
